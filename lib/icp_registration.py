...
# ソース点群・ターゲット点群・ソースに対するターゲットの対応点のindexリストの3つの入力からOpen3Dで可視化可能なLineSetを作成
...
def visualize_icp_progress( reg ):
    ...
    def reg( vis ):
        ...
        # 描画用にソース点群・ターゲット点群・ソースに対するターゲットの対応点を準備
